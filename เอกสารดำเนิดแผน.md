...
3. `rm -rf .next && pnpm run build && vercel --prod`
4. ทดสอบ:
```bash
...
curl -L -X POST 'https://wtdzymuisbtrumguszpm.supabase.co/functions/v1/hello-world' -H 'Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind0ZHp5bXVpc2J0cnVtZ3VzenBtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODc4MDQ1ODEsImV4cCI6MjEwMzM4MDU4MX0.1cYNnvxYlwMr55QZ2kJhuShEM6c80JItW_ZBre1h_rQ' --data '{"name":"Functions"}'
